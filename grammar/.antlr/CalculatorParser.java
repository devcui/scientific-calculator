...
public class CalculatorParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, VAR=5, PI=6, E=7, ID=8, IMAG=9, BIN=10, 
		OCT=11, HEX=12, DECIMAL=13, NUMBER=14, PLUS=15, MINUS=16, MULT=17, DIV=18, 
		MOD=19, POW=20, ASSIGN=21, LPAREN=22, RPAREN=23, LBRACK=24, RBRACK=25, 
		COMMA=26, SEMICOLON=27, EQUAL=28, NOT_EQUAL=29, LESS_EQUAL=30, GREATER_EQUAL=31, 
		LESS=32, GREATER=33, FACT=34, LINE_COMMENT=35, BLOCK_COMMENT=36, WS=37, 
		NEWLINE=38;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'print'", "'or'", "'and'", "'not'", "'var'", "'pi'", "'e'", null, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, "VAR", "PI", "E", "ID", "IMAG", "BIN", 
			"OCT", "HEX", "DECIMAL", "NUMBER", "PLUS", "MINUS", "MULT", "DIV", "MOD", 
			"POW", "ASSIGN", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", "SEMICOLON", 
			"EQUAL", "NOT_EQUAL", "LESS_EQUAL", "GREATER_EQUAL", "LESS", "GREATER", 
			"FACT", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "NEWLINE"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 274898994162L) != 0)) {
				{
				{
				setState(50);
				statement();
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 21087184L) != 0)) {
				{
				setState(226);
				argList();
				}
